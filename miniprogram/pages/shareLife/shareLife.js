...
Page({
  ...
  onViewShareLife:function(e){
    ...
    publishUtil.addViewTimes(tmpShareLife._id).then(res=>{
   
      tmpShareLife.viewTimes++;
      ...
      wx.hideLoading();
      wx.navigateTo({
        url: '../viewShareLife/viewShareLife?_id=' + tmpShareLife._id,
      })
    }).catch(err=>{
      wx.hideLoading();
    });
